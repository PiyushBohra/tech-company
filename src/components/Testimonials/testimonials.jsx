...
const testimonialsData = [

  {
    ...
    {
    text: "Tech Zenon exceeded our expectations with their exceptional website development. Their team’s innovative approach and attention to detail transformed our online presence. The project was completed on time, and their support has been outstanding. Highly recommend them for any tech needs.",
    name: "Shahzad Azmi",
